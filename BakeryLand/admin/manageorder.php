...
<body>
  ...
  <nav id="menu">
    ...
    <a class="dead" href="./manageorder.php"><span class="material-symbols-outlined">edit</span> Order</a>
    ...
    <article>
      ...
      if ($stmt->rowCount() > 0) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
          ...
          echo "<td><a class='detail' href='orderdetail.php?OrderID={$row['OrderID']}'>View Detail</td>";
          echo "</tr>";
        }
      } else {
