...
<body>
    ...
    <main>
        <h1>Add Item</h1>
        <article>
            <form class="main-form" action="../../manage/insert-item.php" method="post" enctype="multipart/form-data">
                </div>
                ...
                <div class="container">
                    ...
                    Base Price: <input type="number" name="bprice" required><br>
                    Description:<br> <textarea name="des" rows="5" cols="30" required></textarea><br>
                    Available: <input type="checkbox" name="stock" value="1"><br>
