...
<head>
    ...
    <script>
        function updatePrice() {
            ...
            var sizeSelect = document.getElementById('cupSize');
...
<body>
    ...
    <main>
        ...
        <article style="display: flex; justify-content: center;">
            ...
            $optionStmt = $pdo->prepare("SELECT * FROM ItemOption WHERE OptionType = 'Size'");
            $optionStmt->execute();
            ...
            <div class="detailcake">
                ...
                <div class="details">
                    ...
                    <form method="post" action="./manage/manage-cart.php?action=add">
                        ...
                        <label for="option">Select cup size:</label>
                        <select name="option" id="cupSize" required onChange="updateQtyField()">
                            ...
                            <?php foreach ($options as $option): ?>
                                <option value="<?= htmlspecialchars($option["OptionValue"]) ?>"
                                    ...
                                    <?= htmlspecialchars($option["OptionValue"]) ?> (add
                                    <?= htmlspecialchars($option["AdditionalCost"]) ?> ฿)
                                </option>
                            <?php endforeach; ?>
                        </select><br>
