...
<body>
  ...
  <nav id="menu">
    ...
    <a class="dead" href="./bread.php">Bread</a>
  ...
  <main>
    ...
    <article>
      <div class="category-section">
        <?php
        $query = "SELECT * FROM Item WHERE Category = 'Bread' AND Available = '1'";
        $params = [];
        ...
        ");
          ...
          <div style="padding: 15px; text-align: center">
            <a href="./detailbread.php?ItemID=<?= $row["ItemID"] ?>">
              <img class="select-img" src='./images/<?= $row["ItemIMG"] ?>'>
            </a><br>
